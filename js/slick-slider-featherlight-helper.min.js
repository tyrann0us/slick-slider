...
a){$(a).find(s.slickSliderLinkSelector).filter(slickSliderFeatherlightHelper.testImages).featherlightGallery({afterContent:function(){var a=this.$instance,b=this.$currentTarget,c=b.parent().find(s.slickSliderCaptionSelector);s.targetSlider=b.parents(s.slickSliderSelector);a.find(".caption").remove();c.length&&$('<div class="caption">').html(c.html()).appendTo(a.find(s.featherlightContentSelector))},afterClose:function(){s.targetSlider=null}})},testImages:function(b,a){return/(.png|.jpg|.jpeg|.gif|.tiff|.bmp)$/.test($(a).attr("href").toLowerCase().split("?")[0].split("#")[0])},
